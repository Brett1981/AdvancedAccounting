...
<styleLibrary>
      ...
      <styles>
        ...
        <style role="Button">
          <states>
            ...
            <state name="HotTracked" foreColor="Gray" imageBackgroundStyle="Stretched"
        ...
        <style role="ExplorerBarGroupHeader">
          <states>
            ...
            <state name="Expanded" backColor="Transparent" imageBackgroundStyle="Stretched" backGradientStyle="None"
                   backHatchStyle="None" imageBackgroundStretchMargins="4, 4, 4, 3">
        ...
        <style role="GridBandHeader">
          <states>
            <state name="Normal" backColor="LightGray" foreColor="45, 45, 45" borderColor="Transparent"
                   textHAlign="Left" imageBackgroundStyle="Stretched" fontBold="True" fontSize="12" backColor2="White"
                   backGradientStyle="Vertical" imageBackgroundStretchMargins="2, 4, 2, 5" />
          </states>
        </style>
        <style role="GridCaption">
          <states>
            <state name="Normal" backColor="WhiteSmoke" borderColor="Transparent" fontBold="True" fontSize="11"
        ...
        <style role="GridRow">
          <states>
            ...
            <state name="Selected" backColor="WhiteSmoke" foreColor="DimGray" backGradientStyle="None"
                   backHatchStyle="None" />
            <state name="Active" backColor="Transparent" imageBackgroundStyle="Stretched" fontBold="True"
                   backGradientStyle="None" imageBackgroundStretchMargins="3, 3, 3, 3">
        ...
        <style role="GridRowSelector">
          <states>
            <state name="Normal" backColor="WhiteSmoke" foreColor="172, 22, 47" borderColor="WhiteSmoke"
                   imageHAlign="Right" imageVAlign="Middle" backGradientStyle="None" />
        ...
        <style role="ScheduleCurrentDayHeader">
          <states>
            <state name="Normal" backColor="210, 210, 210" foreColor="45, 45, 45" backGradientStyle="None"
                   backHatchStyle="None" />
          </states>
        </style>
        ...
        <style role="ScrollBarTrackVertical">
          <states>
            <state name="Normal" backColor="Transparent" imageBackgroundStyle="Stretched" backGradientStyle="None"
                   backHatchStyle="None" imageBackgroundStretchMargins="0, 12, 0, 13">
        ...
        <style role="TabItemHorizontalBottom" buttonStyle="FlatBorderless">
          <states>
            <state name="Normal" backColor="White" foreColor="WhiteSmoke" borderColor="Transparent"
                   imageBackgroundStyle="Stretched" borderAlpha="Transparent" fontBold="True" fontSize="9"
                   backGradientStyle="None" backHatchStyle="None" imageBackgroundStretchMargins="9, 0, 12, 11">
            ...
            <state name="Selected" backColor="White" foreColor="White" imageBackgroundStyle="Stretched"
                   backGradientStyle="None" backHatchStyle="None" imageBackgroundStretchMargins="9, 0, 11, 10">
        ...
        <style role="TabItemHorizontalTop" buttonStyle="Flat">
          <states>
            <state name="Normal" backColor="Transparent" foreColor="White" borderColor="Transparent"
                   imageBackgroundStyle="Stretched" borderAlpha="UseAlphaLevel" fontBold="True"
                   backGradientStyle="None" imageBackgroundStretchMargins="9, 8, 13, 0">
            ...
            <state name="Selected" foreColor="White" imageBackgroundStyle="Stretched"
                   imageBackgroundStretchMargins="13, 8, 14, 0">
        ...
        <style role="TabItemVerticalLeft">
          <states>
            <state name="Normal" backColor="Transparent" imageBackgroundStyle="Stretched" backGradientStyle="None"
                   imageBackgroundStretchMargins="14, 9, 0, 11">
            ...
            <state name="Selected" foreColor="White" imageBackgroundStyle="Stretched" fontBold="True"
                   imageBackgroundStretchMargins="15, 10, 0, 11">
        ...
        <style role="TabItemVerticalRight">
          <states>
            <state name="Normal" backColor="Transparent" foreColor="White" imageBackgroundStyle="Stretched"
                   borderAlpha="Transparent" fontBold="True" backGradientStyle="None"
                   imageBackgroundStretchMargins="0, 9, 16, 9">
            ...
            <state name="Selected" foreColor="White" imageBackgroundStyle="Stretched" fontBold="True"
                   imageBackgroundStretchMargins="0, 8, 10, 12">
    ...
    <styleSet name="ApplicationTitle">
      <styles>
        ...
        <style role="UltraLabel">
          <states>
            <state name="Normal" backColor="Transparent" foreColor="Black" backGradientStyle="None"
                   backHatchStyle="None" />
          </states>
        </style>
      </styles>
  ...
  <resources>
    <resource name="Background" backColor="White" borderColor="LightGray" backColor2="Gainsboro"
              backGradientStyle="Vertical" />
    <resource name="background_hover" backColor="75, 75, 75" foreColor="Black" borderColor="Transparent"
              backColor2="White" backGradientStyle="Vertical" />
    <resource name="border" backColor="Transparent" borderColor="51, 51, 51" backGradientStyle="None"
              backHatchStyle="None" />
    <resource name="button" backColor="Transparent" foreColor="DimGray" borderColor="Transparent"
              imageBackgroundStyle="Stretched" backGradientStyle="None" imageBackgroundStretchMargins="3, 3, 3, 3">
      <imageBackground></imageBackground>
    </resource>
    <resource name="ExplorerBarGroupHeader_Normal" backColor="Transparent" foreColor="White" borderColor="Transparent"
              imageBackgroundStyle="Stretched" backGradientStyle="None" backHatchStyle="None"
              imageBackgroundStretchMargins="8, 2, 8, 2">
